...
namespace Drupal\custom_api\Generators;

use DrupalCodeGenerator\Command\ModuleGenerator;
use DrupalCodeGenerator\Utils;

/**
 * WARNING, THIS IS AN OLD VERSION OF THE GENERATOR FOR DRUSH 11/ CODE GENERATOR 2.x
 */
class ApiPluginGenerator extends ModuleGenerator {

  protected string $name = 'custom:api-plugin';
  protected string $description = 'Generates an custom API plugin';
  protected string $templatePath = 'modules/custom/custom_api/src/Templates';
  ...
  protected function generate(array &$vars): void {
    ...
    $this->addFile('src/Plugin/CustomApi/{entity_type_ucfirst}/{bundle_camelize}.php', 'PluginTemplate.twig');
  }
